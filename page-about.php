          ...
          <div <?php post_class( 'page' ); ?>>
            <div class="page__content">
              <div class="story">
                ...
                <p>Schon vor mehr als einem Jahr (Frühling 2017) haben die heutigen Zeitungsgründer Melanie (hat die Redaktion verlassen), Paul,
                  ...
                  Livestreams, Umfragen, und vielem mehr) haben. Bei Interesse würden wir uns freuen, wenn du uns mithilfe des <a href="<?php echo get_home_url(); ?>/contact">Kontaktformulars</a>,
                  <a href="mailto:redaktion@duispaper.de" target="_blank">per E-Mail</a> oder persönlich (bei einem unserer Redakteure) kontaktierst. Bei Vorschlägen
                  für neue Beitragsarten, anonyme Beiträge oder ähnlichem kannst du das Formular unter <a href="<?php echo get_home_url(); ?>/your-contribution">Dein Beitrag</a> benutzen.
                </p>
              </div>
              <div class="team">
                <h2>Unser Team</h2>
