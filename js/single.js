...
$(document).ready(function () {
    ...
    const $images = jQuery('p > img:not(.emoji), .wp-caption, figure.wp-block-image, .wp-block-image > figure , .blocks-gallery-item > figure, figure.wp-block-media-text__media, .wp-block-media-text__media > figure');
