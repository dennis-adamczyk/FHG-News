$(document).ready(function() {
  ...
  $('.content .main .image-container .image').click(function(event) {
    var lightboxID = $(this).css('background-image').replace('url("https://duispaper.de/additional-content/qr/3/KlassenfahrtDer6er/img/', '');
    lightboxID = lightboxID.replace('url("https://www.duispaper.de/additional-content/qr/3/KlassenfahrtDer6er/img/', '');
  ...
  if(~window.location.href.indexOf("?lightbox")) {
    ...
    $('.content .lightbox .header .download').click(function(event) {
      ...
      link.download = 'Klassenfahrt der 6er - ' + image + '.jpg';
