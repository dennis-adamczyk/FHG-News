$(document).ready(function() {
  ...
  if($.inArray(window.navigator.platform, androidOS) >= 0 || window.navigator.platform == null) {
    /* Android */
    window.location.replace("https://play.google.com/store/apps/details?id=tv.nexx.android.thesimpleclub&hl=de");
  } else if($.inArray(window.navigator.platform, iOS) >= 0) {
    /* iOS */
    window.location.replace("https://itunes.apple.com/de/app/thesimpleclub/id1089299986?mt=8");
  } else if($.inArray(window.navigator.platform, windowsOS) >= 0) {
    /* Windows */
    window.location.replace("https://www.microsoft.com/de-de/store/p/thesimpleclub/9nblggh4xvmh");
  } else {
    window.location.replace("https://play.google.com/store/apps/details?id=tv.nexx.android.thesimpleclub&hl=de");
  }
