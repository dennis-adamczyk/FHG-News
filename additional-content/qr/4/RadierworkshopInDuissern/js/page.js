$(document).ready(function() {
  ...
  for(var i = 0; i < imgAmount; i++) {
    ...
    $imgContainer.append('<div class="image" style=\'background-image: url("img/' + (i+1) + '.jpg")\'></div>');
  }

  $('.content .main .image-container .image').click(function(event) {
    var lightboxID = $(this).css('background-image').replace('url("https://duispaper.de/additional-content/qr/4/RadierworkshopInDuissern/img/', '');
    lightboxID = lightboxID.replace('url("https://www.duispaper.de/additional-content/qr/4/RadierworkshopInDuissern/img/', '');
  ...
  if(~window.location.href.indexOf("?lightbox")) {
    ...
    $('.content .lightbox .header .download').click(function(event) {
      ...
      link.download = 'Radierworkshop in Duissern - ' + image + '.jpg';
